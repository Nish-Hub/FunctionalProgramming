...
public class PersonListMethodReference {
	public static void main(String[] args) {
		...
		printConditionally(personList,p ->p.getFirstName().startsWith("c"),System.out::println); //p -> method(p) This can be replaced . The java
    //Compiler takes this reference , passes it to the Consumer interface and then provides it the method parameter at line
    // 32 as cons.accept(p)
